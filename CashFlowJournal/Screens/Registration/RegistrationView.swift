    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 2) {
                ...
                TextField("registration_username_hint", text: $usernameValue)
